<h2><a href="https://leetcode.com/problems/find-the-peaks/">2951. Find the Peaks</a></h2><h3>Easy</h3><hr><div><p>You are given a <strong>0-indexed</strong> array <code style="">mountain</code>. Your task is to find all the <strong>peaks</strong> in the <code style="">mountain</code> array.</p>
...
<pre style=""><strong>Input:</strong> mountain = [2,4,4]
...
<pre style=""><strong>Input:</strong> mountain = [1,4,3,8,5]
...
<ul>
	<li><code style="">3 &lt;= mountain.length &lt;= 100</code></li>
	<li><code style="">1 &lt;= mountain[i] &lt;= 100</code></li>
</ul>
</div>